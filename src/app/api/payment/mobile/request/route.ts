...
// KG이니시스 모바일 설정 - 임시로 테스트 MID 하드코딩
const P_MID = "INIpayTest"; // process.env.INICIS_MOBILE_MID || process.env.INICIS_MID || "INIpayTest";
const HASH_KEY = "3CB8183A4BE283555ACC8363C0360223"; // process.env.INICIS_MOBILE_HASH_KEY || "3CB8183A4BE283555ACC8363C0360223";
